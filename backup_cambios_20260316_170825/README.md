...
- 📤 Cargar datos base (CDP, CRP, Seguimiento) con un clic
...
1. Haz clic en "⚡ Cargar datos base (CDP, CRP, Seguimiento)"
2. Esto descargará los archivos Excel más recientes
3. Tus datos se mostrarán en las pestañas (CDP, CRP, Seguimiento)
4. Usa los filtros para buscar registros específicos
5. Pagina entre resultados con Anterior/Siguiente
...
| POST | `/api/excel/load-default-datasets` | Cargar CDP, CRP, Seguimiento |
...
1. **Opción A (Recomendada)** - Reemplazar todo:
   - En Upload → Botón "Cargar datos base"
   - Vacía y recarga las 3 tablas automáticamente

2. **Opción B** - Agregar a tabla específica:
